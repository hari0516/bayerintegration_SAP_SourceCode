...
/**
 * <p>Java class for BayerProjectAPIResultType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BayerProjectAPIResultType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ObjectResult" type="{http://ecosys.net/api/BayerProjectAPI}ObjectResultType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Performance" type="{http://ecosys.net/api/BayerProjectAPI}PerformanceType" minOccurs="0"/>
 *         &lt;element name="Error" type="{http://ecosys.net/api/BayerProjectAPI}ErrorType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "BayerProjectAPIResultType", propOrder = {
    "meta",
    "bayerProjectAPI",
    "objectResult",
    "performance",
...
public class BayerProjectAPIResultType {
    ...
    protected List<PRJObjectResultType> objectResult;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRJObjectResultType }
     * 
     * 
     */
    public List<PRJObjectResultType> getObjectResult() {
        if (objectResult == null) {
            objectResult = new ArrayList<PRJObjectResultType>();
        }
