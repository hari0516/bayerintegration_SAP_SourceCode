...
/**
 * <p>Java class for BayerWBSAPIResultType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BayerWBSAPIResultType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ObjectResult" type="{http://ecosys.net/api/BayerWBSAPI}ObjectResultType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Performance" type="{http://ecosys.net/api/BayerWBSAPI}PerformanceType" minOccurs="0"/>
 *         &lt;element name="Error" type="{http://ecosys.net/api/BayerWBSAPI}ErrorType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "BayerWBSAPIResultType", propOrder = {
    "meta",
    "bayerWBSAPI",
    "objectResult",
    "performance",
...
public class BayerWBSAPIResultType {
    ...
    protected List<WObjectResultType> objectResult;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WObjectResultType }
     * 
     * 
     */
    public List<WObjectResultType> getObjectResult() {
        if (objectResult == null) {
            objectResult = new ArrayList<WObjectResultType>();
        }
