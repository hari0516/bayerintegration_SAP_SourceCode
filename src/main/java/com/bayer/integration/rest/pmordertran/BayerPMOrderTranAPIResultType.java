...
/**
 * <p>Java class for BayerPMOrderTranAPIResultType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BayerPMOrderTranAPIResultType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ObjectResult" type="{http://ecosys.net/api/BayerPMOrderTranAPI}ObjectResultType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Performance" type="{http://ecosys.net/api/BayerPMOrderTranAPI}PerformanceType" minOccurs="0"/>
 *         &lt;element name="Error" type="{http://ecosys.net/api/BayerPMOrderTranAPI}ErrorType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "BayerPMOrderTranAPIResultType", propOrder = {
    "meta",
    "bayerPMOrderTranAPI",
    "objectResult",
    "performance",
...
public class BayerPMOrderTranAPIResultType {
    ...
    protected List<PMOTObjectResultType> objectResult;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PMOTObjectResultType }
     * 
     * 
     */
    public List<PMOTObjectResultType> getObjectResult() {
        if (objectResult == null) {
            objectResult = new ArrayList<PMOTObjectResultType>();
        }
